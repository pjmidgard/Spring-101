...
Should not repeat together ones and zeroes because we should skip numbers with 1 and 0. It should increase when we at list find that predict 1 time. Count times when find at least one time.
